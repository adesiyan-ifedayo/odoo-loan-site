...
class Employee(models.Model):
    ...
    country_id = fields.Many2one(
        'res.country', string ='  ', groups="hr.group_hr_user")
    ...
    marital = fields.Selection([
        ...
        ('widower', 'Widower'),
        ('divorced', 'Divorced')
    ], string='  ', groups="hr.group_hr_user", default=' ')
    ...
    country_of_birth = fields.Many2one('res.country', string=" ", groups="hr.group_hr_user")
    ...
    #mine
    home_id = fields.Char('Home Address')
    bank_account_ids = fields.Char('Bank Account Number')
    bank_name = fields.Char('Name of Bank')
    account_name = fields.Char('Account Holder Name')
    country_ids = fields.Char('Nationality')
    genders = fields.Char('Gender-')
    marital_status = fields.Char('Marital Status-')
    certificate_level = fields.Char('Level of Certification')
    birth_country = fields.Char('Country of Birth')
    birthday = fields.Date('Date of Birth')
    address_ids = fields.Char('Work Address')
    ...
    certificate = fields.Selection([
        ...
        ('master', 'Master'),
        ('other', 'Other'),
    ], ' ', default=' ', groups="hr.group_hr_user")
